...
<sub>StudentVUE is a registered trademark of Edupoint Educational Systems LLC. AscentaCompass is not affiliated with or endorsed by Edupoint Educational Systems LLC.</sub>
...
This copy is rebranded for Ascenta-hosted deployment. If you make further public modifications, keep the branding and contact details accurate so users are not confused about who operates the app.

Vercel and Netlify are both good options for hosting SvelteKit apps like AscentaCompass.
